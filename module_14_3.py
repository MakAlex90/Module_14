...
async def get_buying_list(message):
    with open('foto/1.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Огурец | Описание: описание 1 | Цена: 100p')
    with open('foto/2.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Помидор | Описание: описание 2 | Цена: 200p')
    with open('foto/3.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Редис | Описание: описание 3 | Цена: 300p')
    with open('foto/4.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Тыква | Описание: описание 4 | Цена: 400p')
